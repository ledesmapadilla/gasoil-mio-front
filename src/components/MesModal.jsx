...
const estilos = {
  ...
  body: { padding: "0.75rem 1rem", overflowY: "auto" },
  footer: {
    padding: "0.5rem 1rem",
  ...
  inputTabla: {
    width: "70px", padding: "0.2rem 0.3rem",
    background: "#111", color: "#fff",
    border: "1px solid #555", borderRadius: "0.3rem",
    fontSize: "0.85rem", textAlign: "center",
  },
  btnCerrarX: { background: "none", border: "none", color: "#aaa", fontSize: "1.1rem", cursor: "pointer" },
  btnCerrar: { background: "transparent", border: "1px solid #666", color: "#aaa", padding: "0.3rem 1rem", borderRadius: "0.375rem", cursor: "pointer" },
  btnCupo: { background: "transparent", border: "1px solid #666", color: "#fff", padding: "0.15rem 0.5rem", fontSize: "0.8rem", borderRadius: "0.375rem", cursor: "pointer" },
  btnVerde: { background: "transparent", border: "1px solid #198754", color: "#198754", padding: "0.15rem 0.4rem", borderRadius: "0.375rem", cursor: "pointer" },
  btnGris: { background: "transparent", border: "1px solid #666", color: "#aaa", padding: "0.15rem 0.4rem", borderRadius: "0.375rem", cursor: "pointer" },
  btnRojo: { background: "transparent", border: "none", cursor: "pointer", fontSize: "1rem" },
};
